...
// *****************************************************************
// Création du custom post type pour l'équipe de l'association
// *****************************************************************
function custom_post_equipe() { 
	// creating (registering) the custom type 
	register_post_type( 'cael_equipe', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Membres de l&acute;équipe', 'cael'), /* This is the Title of the Group */
			...
			'description' => __( 'Permet de définir les membres apparaissant sur la page Le CAEL', 'cael' ), /* Custom Type Description */
			'public' => true,
