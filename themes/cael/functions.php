<?php
/**
 * cael functions and definitions
 *
...
if ( ! function_exists( 'cael_setup' ) ) :
	...
	function cael_setup() {
		 ...
		 * If you're building a theme based on cael, use a find and replace
		 * to change 'cael' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'cael', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'cael_custom_background_args', array(
...
add_action( 'after_setup_theme', 'cael_setup' );
 ...
 */
function cael_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'cael_content_width', 640 );
}
add_action( 'after_setup_theme', 'cael_content_width', 0 );
 ...
 */
function cael_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'cael' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cael' ),
...
add_action( 'widgets_init', 'cael_widgets_init' );
...
function cael_scripts() {
	...
	wp_enqueue_script( 'cael-js', get_template_directory_uri() . '/js/cael.js', array('jquery'), '20180424', true );

	/*if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}*/
}
add_action( 'wp_enqueue_scripts', 'cael_scripts' );
